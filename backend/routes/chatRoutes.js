...
const { getAllChats, accessChat, createGroup, renameGroup, addToGroup, removeFromGroup, deleteGroup, updateGroup } = require('../controllers/chatControllers');
...
router.route("/group/update").put(protect, updateGroup)
